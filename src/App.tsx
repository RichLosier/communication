...
function App() {
  ...
  if (currentView === 'crm') {
    return (
      <CrmDashboard onBack={() => setCurrentView('messages')} />
    );
  }
            ...
            <div className="flex items-center justify-between mb-6">
              ...
              <div className="flex items-center gap-4">
                ...
                <button
                  ...
                  className="flex items-center gap-2 bg-emerald-600 hover:bg-emerald-700 text-white rounded-xl px-4 py-2 transition-colors font-medium shadow-lg hover:shadow-xl"
                  title="Pipeline CRM - Réouverture de comptes"
                >
                  <Building2 className="h-5 w-5" />
                  <span>CRM Comptes</span>
                </button>
